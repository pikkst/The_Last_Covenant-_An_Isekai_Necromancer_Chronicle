...
Docker Compose provides PostgreSQL and Redis, with optional observability and local AI profiles. Application processes may run on host for fast development or in containers for parity.
